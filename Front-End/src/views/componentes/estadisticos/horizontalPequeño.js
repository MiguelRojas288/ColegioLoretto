...
const ComponenteHorizontalPequeño = ({ icon, color, stats, renderStats, statTitle, className, statsMargin }) => {
  return (
    <Card>
...
export default ComponenteHorizontalPequeño

// ** PropTypes
ComponenteHorizontalPequeño.propTypes = {
